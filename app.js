// ==================== CONFIG ====================
const CONFIG = {
    groqKey: localStorage.getItem('jarvis_api_key') || 'gsk_YOUR_KEY_HERE',
    agent: 'voice',
    agents: {
    ...
    try {
        const res = await fetch('https://api.groq.com/openai/v1/chat/completions', {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    { role: 'system', content: `أنت JARVIS. ${CONFIG.agents[CONFIG.agent].prompt}. أجب بالعربية.` },
